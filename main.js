...
function switchSide() {
  if (isSevenDays) {
    ...
    for (let i = 0; i < weekDays.length; i++) {
      ...
      h4day.textContent = weekDays[i];
      h6Day.textContent = data.forecast.forecastday[i].day.condition.text;
      h6Day.style.fontSize = "16px";
      imgDay.src = data.forecast.forecastday[i].day.condition.icon;
      //   parDay.textContent =
